...
>
> The periodic audit produces an audit findings record fed into the V&V evidence base (§7.6). Findings without resolution at the next scheduled audit are escalated per §9.2 review escalation procedures.
